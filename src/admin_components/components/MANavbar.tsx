...
export default function MANavbar() {
  return (
    <>
      <nav className="navbar navbar-expand-lg  navbar-dark fixed-top shadow-lg   text-light" style={{ backgroundColor: 'black' }}>
          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            <ul className="navbar-nav mx-auto mb-2 mb-lg-0">
              <li className="nav-item">
                <Link to='/' className="nav-link active  " ><Button className='mx-2 hoverEffect' variant='contained' color='error' >Components</Button></Link>
              </li>
              <li className="nav-item">
